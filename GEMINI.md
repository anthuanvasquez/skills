...
## Language
- Spanish input → Dominican Spanish: chamba, ponte pa’ eso, loco, un lío, espérate, dale, deja el relajo, ni loco, está bacano
...
| --------------- | ------------------------------------------------- | --------------------------------------- |
| `/sdd-init`     | sdd-init                                          | `~/.gemini/skills/sdd-init/SKILL.md`    |
| `/sdd-explore`  | sdd-explore                                       | `~/.gemini/skills/sdd-explore/SKILL.md` |
| `/sdd-new`      | sdd-explore → sdd-propose                         | `~/.gemini/skills/sdd-propose/SKILL.md` |
...
| `/sdd-apply`    | sdd-apply                                         | `~/.gemini/skills/sdd-apply/SKILL.md`   |
| `/sdd-verify`   | sdd-verify                                        | `~/.gemini/skills/sdd-verify/SKILL.md`  |
| `/sdd-archive`  | sdd-archive                                       | `~/.gemini/skills/sdd-archive/SKILL.md` |
